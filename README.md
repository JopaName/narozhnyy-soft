...
| 🛰 **Спутниковый снимок** | Введите адрес — приложение скачает снимок Esri World Imagery и автоматически откалибрует масштаб (метры из зума и широты) |
| 🗺 **Оффлайн-карты** | Скачайте пакет региона (тайлы) — карта и поиск улиц работают без интернета; маркер → спутниковая подложка для обводки крыши |
| ⌨ **Автоподсказка адреса** | При вводе адреса — подсказки: оффлайн-улицы из пакета региона + онлайн Nominatim |
...
| 🧾 **Детальная смета (BOM)** | Крепёж, кабели DC/AC, автоматы, УЗИП, счётчик, мониторинг — количества от панелей и стрингов, цены из каталога |
| 🔀 **Варианты (как в OpenSolar)** | Полные копии системы для сравнения: таблица метрик + денежные потоки на одном графике + блок сравнения в КП |
...
<div align="center">
  ...
  <img src="docs/screenshots/7-variants.png" width="45%" alt="Варианты">
</div>
